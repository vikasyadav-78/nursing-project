...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "name": "description",
        "content": "Find Top Arts Colleges in India based on  ranking with details on courses, fees, placements, admission, reviews, cut off, and latest news."
      },
      {
        "property": "og:type",
        "content": "website"
      ...
      {
        "property": "og:title",
        "content": "Top Arts Colleges in India 2025: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/arts-colleges"
      },
      {
  ...
  return (
    <>
          ...
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              <h1 className={"college__Landing__Hero__Section__Heading"}>
                {"Top Arts Colleges in India 2026"}
              </h1>
            </div>
          </div>
        </div>
          ...
          <div className={"col-md-6 mobile__white__bg"}>
            <div className={"filter__selected__container"}>
              <div id={"selectedFilters"} className={"filterDiv"}>
                <button id={"arts"} data-attr={"stream"} className={"filter__selected"}>
                  {"Arts"}
            ...
            <div className={"filtered__colleges__list"}>
              <div className={"searchedcollegeList"}>
                    <div className={"college__card__new "} key={"LSR01"} id={"search-LSR01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            ...
                            alt={"Lady Shri Ram College for Women (LSR), New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/LSR01")} title={"Lady Shri Ram College for Women (LSR), New Delhi"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Lady Shri Ram College for Women (LSR), New Delhi Reviews"} href={allowedLink("/reviews")}>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Lady Shri Ram College for Women (LSR), New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: LSR01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Lady Shri Ram College for Women (LSR), New Delhi Courses"}>
                                  {"24 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Lady Shri Ram College for Women (LSR), New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Lady Shri Ram College for Women (LSR), New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"SSC01"} id={"search-SSC01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"St. Stephen's College, New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/SSC01")} title={"St. Stephen's College, New Delhi"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"St. Stephen's College, New Delhi Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"St. Stephen's College, New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: SSC01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"St. Stephen's College, New Delhi Courses"}>
                                  {"18 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"St. Stephen's College, New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"St. Stephen's College, New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"LOY01"} id={"search-LOY01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                          ...
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/LOY01")} title={"Loyola College, Chennai"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Loyola College, Chennai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Loyola College, Chennai is a top accredited Private institute located in Chennai, Tamil Nadu. Code: LOY01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Loyola College, Chennai Courses"}>
                                  {"22 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Loyola College, Chennai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Loyola College, Chennai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"HIN01"} id={"search-HIN01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Hindu College, New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/HIN01")} title={"Hindu College, New Delhi"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Hindu College, New Delhi Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Hindu College, New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: HIN01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Hindu College, New Delhi Courses"}>
                                  {"20 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Hindu College, New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Hindu College, New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"SXM01"} id={"search-SXM01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"St. Xavier's College, Mumbai"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/SXM01")} title={"St. Xavier's College, Mumbai"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"St. Xavier's College, Mumbai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"St. Xavier's College, Mumbai is a top accredited Private institute located in Mumbai, Maharashtra. Code: SXM01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"St. Xavier's College, Mumbai Courses"}>
                                  {"16 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"St. Xavier's College, Mumbai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"St. Xavier's College, Mumbai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <div className={"desktopOnly getSupport college-filter-get-support"}>
        <div className={"brochureBtn filter-college-scholership leadFilterData predict-my-college-cta"} data-filter={"college-listing"} data-entity={"college"} data-lead_cta={"22"} data-stream={"arts"} data-ctalocation={"colleges_listing_card_predict_my_college"}></div>
      </div>
...
export default function ArtsPage({ onNavigate }) {
  return (
