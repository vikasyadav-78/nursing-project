...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "name": "description",
        "content": "Find TopScience Colleges in India based on  ranking with details on courses, fees, placements, admission, reviews, cut off, and latest news."
      },
      {
        "property": "og:type",
        "content": "website"
      ...
      {
        "property": "og:title",
        "content": "Top Science Colleges in India 2025: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/science-colleges"
      },
      {
  ...
  return (
    <>
          ...
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              <h1 className={"college__Landing__Hero__Section__Heading"}>
                {"Top Science Colleges in India 2026"}
              </h1>
              <h2>
                {"Top Science Colleges in India as per NIRF 2024"}
              </h2>
              ...
              <h2>
                {"Top Private Science Colleges in India"}
              </h2>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                <colgroup>
                  <col width={"357"} />
              ...
              <h2>
                {"Top Govt. Science Colleges in India"}
              </h2>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                <colgroup>
                  <col width={"385"} />
          ...
          <div className={"col-md-6 mobile__white__bg"}>
            <div className={"filter__selected__container"}>
              <div id={"selectedFilters"} className={"filterDiv"}>
                <button id={"science"} data-attr={"stream"} className={"filter__selected"}>
                  {"Science"}
            ...
            <div className={"filtered__colleges__list"}>
              <div className={"searchedcollegeList"}>
                    <div className={"college__card__new "} key={"IISC01"} id={"search-IISC01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            ...
                            alt={"Indian Institute of Science (IISc), Bengaluru"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/IISC01")} title={"Indian Institute of Science (IISc), Bengaluru"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Indian Institute of Science (IISc), Bengaluru Reviews"} href={allowedLink("/reviews")}>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Indian Institute of Science (IISc), Bengaluru is a top accredited Government institute located in Bengaluru, Karnataka. Code: IISC01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Indian Institute of Science (IISc), Bengaluru Courses"}>
                                  {"35 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Indian Institute of Science (IISc), Bengaluru"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Indian Institute of Science (IISc), Bengaluru"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"SSC-SCI"} id={"search-SSC-SCI"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"St. Stephen's College (Science Dept), New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/SSC-SCI")} title={"St. Stephen's College (Science Dept), New Delhi"}>
                                {"St. Stephen's College (Science Dept), New Delhi"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"St. Stephen's College (Science Dept), New Delhi Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"St. Stephen's College (Science Dept), New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: SSC-SCI."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"St. Stephen's College (Science Dept), New Delhi Courses"}>
                                  {"14 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"St. Stephen's College (Science Dept), New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"St. Stephen's College (Science Dept), New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"HIN-SCI"} id={"search-HIN-SCI"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Hindu College (Science Dept), New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/HIN-SCI")} title={"Hindu College (Science Dept), New Delhi"}>
                                {"Hindu College (Science Dept), New Delhi"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Hindu College (Science Dept), New Delhi Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Hindu College (Science Dept), New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: HIN-SCI."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Hindu College (Science Dept), New Delhi Courses"}>
                                  {"16 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Hindu College (Science Dept), New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Hindu College (Science Dept), New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"LOY-SCI"} id={"search-LOY-SCI"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Loyola College (School of Sciences), Chennai"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/LOY-SCI")} title={"Loyola College (School of Sciences), Chennai"}>
                                {"Loyola College (School of Sciences), Chennai"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Loyola College (School of Sciences), Chennai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Loyola College (School of Sciences), Chennai is a top accredited Private institute located in Chennai, Tamil Nadu. Code: LOY-SCI."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Loyola College (School of Sciences), Chennai Courses"}>
                                  {"20 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Loyola College (School of Sciences), Chennai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Loyola College (School of Sciences), Chennai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"MH01"} id={"search-MH01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Miranda House, New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/MH01")} title={"Miranda House, New Delhi"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Miranda House, New Delhi Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Miranda House, New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: MH01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Miranda House, New Delhi Courses"}>
                                  {"18 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Miranda House, New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Miranda House, New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <div className={"desktopOnly getSupport college-filter-get-support"}>
        <div className={"brochureBtn filter-college-scholership leadFilterData predict-my-college-cta"} data-filter={"college-listing"} data-entity={"college"} data-lead_cta={"22"} data-stream={"science"} data-ctalocation={"colleges_listing_card_predict_my_college"}></div>
      </div>
