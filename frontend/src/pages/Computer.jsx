...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "name": "description",
        "content": "Find Top Computer Colleges in India based on  ranking with details on courses, fees, placements, admission, reviews, cut off, and latest news."
      },
      {
        "property": "og:type",
        "content": "website"
      ...
      {
        "property": "og:title",
        "content": "Top Computer Colleges in India 2025: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/computer-colleges"
      },
      {
  ...
  return (
    <>
      <nav className={"breadcrumbDiv news"}>
        <div className={"container"}>
          <ul className={"breadcrumb"}>
            ...
            <li className={"active"}>
              {"Top Computer Colleges in India"}
            </li>
          </ul>
        </div>
      </nav>
          ...
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              <h1 className={"college__Landing__Hero__Section__Heading"}>
                {"Top Computer Colleges in India 2026"}
              </h1>
            </div>
          </div>
        </div>
          ...
          <div className={"col-md-6 mobile__white__bg"}>
            <div className={"filter__selected__container"}>
              <div id={"selectedFilters"} className={"filterDiv"}>
                <button id={"computer"} data-attr={"stream"} className={"filter__selected"}>
                  {"Computer"}
            ...
            <div className={"filtered__colleges__list"}>
              <div className={"searchedcollegeList"}>
                    <div className={"college__card__new "} key={"NITT-CS"} id={"search-NITT-CS"}>
                        ...
                        <div className={"college__detail__grid"}>
                          ...
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NITT-CS")} title={"National Institute of Technology (NIT), Trichy"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"National Institute of Technology (NIT), Trichy Reviews"} href={allowedLink("/reviews")}>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"National Institute of Technology (NIT), Trichy is a top accredited Government institute located in Tiruchirappalli, Tamil Nadu. Code: NITT-CS."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"National Institute of Technology (NIT), Trichy Courses"}>
                                  {"15 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"National Institute of Technology (NIT), Trichy"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"National Institute of Technology (NIT), Trichy"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"VIT-CS"} id={"search-VIT-CS"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Vellore Institute of Technology (VIT), Vellore"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/VIT-CS")} title={"Vellore Institute of Technology (VIT), Vellore"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Vellore Institute of Technology (VIT), Vellore Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Vellore Institute of Technology (VIT), Vellore is a top accredited Private institute located in Vellore, Tamil Nadu. Code: VIT-CS."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Vellore Institute of Technology (VIT), Vellore Courses"}>
                                  {"28 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Vellore Institute of Technology (VIT), Vellore"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Vellore Institute of Technology (VIT), Vellore"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"IIITH01"} id={"search-IIITH01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"IIIT Hyderabad - International Institute of IT"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/IIITH01")} title={"IIIT Hyderabad - International Institute of IT"}>
                                {"IIIT Hyderabad - International Institute of IT"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"IIIT Hyderabad - International Institute of IT Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"IIIT Hyderabad - International Institute of IT is a top accredited Private institute located in Hyderabad, Telangana. Code: IIITH01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"IIIT Hyderabad - International Institute of IT Courses"}>
                                  {"12 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"IIIT Hyderabad - International Institute of IT"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"IIIT Hyderabad - International Institute of IT"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"SRM-CS"} id={"search-SRM-CS"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"SRM Institute of Science and Technology, Chennai"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/SRM-CS")} title={"SRM Institute of Science and Technology, Chennai"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"SRM Institute of Science and Technology, Chennai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"SRM Institute of Science and Technology, Chennai is a top accredited Private institute located in Chennai, Tamil Nadu. Code: SRM-CS."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"SRM Institute of Science and Technology, Chennai Courses"}>
                                  {"32 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"SRM Institute of Science and Technology, Chennai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"SRM Institute of Science and Technology, Chennai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"BITS-CS"} id={"search-BITS-CS"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"BITS Pilani (Computer Science Dept)"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/BITS-CS")} title={"BITS Pilani (Computer Science Dept)"}>
                                {"BITS Pilani (Computer Science Dept)"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"BITS Pilani (Computer Science Dept) Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"BITS Pilani (Computer Science Dept) is a top accredited Private institute located in Pilani, Rajasthan. Code: BITS-CS."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"BITS Pilani (Computer Science Dept) Courses"}>
                                  {"10 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"BITS Pilani (Computer Science Dept)"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"BITS Pilani (Computer Science Dept)"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <div className={"desktopOnly getSupport college-filter-get-support"}>
        <div className={"brochureBtn filter-college-scholership leadFilterData predict-my-college-cta"} data-filter={"college-listing"} data-entity={"college"} data-lead_cta={"22"} data-stream={"computer"} data-ctalocation={"colleges_listing_card_predict_my_college"}></div>
      </div>
...
export default function ComputerPage({ onNavigate }) {
  return (
