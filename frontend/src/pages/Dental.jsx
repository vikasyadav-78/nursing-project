...
export const page = {
  ...
  head: {
    "meta": [
      ...
      {
        "property": "og:title",
        "content": "Top Dental Colleges in India 2025 2025: Ranking, Courses, Fees & Placements"
      },
      {
        "property": "og:url",
        "content": "/dental-colleges"
      },
      {
  ...
  return (
    <>
      <nav className={"breadcrumbDiv news"}>
        <div className={"container"}>
          <ul className={"breadcrumb"}>
            ...
            <li className={"active"}>
              {"Top Dental Colleges in India 2025"}
            </li>
          </ul>
        </div>
      </nav>
        ...
        <div className={"college__Landing__New"}>
          <div className={"college__Landing__Hero__Section1"}>
            <div className={"college__Landing__Hero__Section pageData pageInfo"}>
              ...
              <p>
                {"Dental studies deal with covering oral health, maintaining hygiene, and preventing oral diseases. The dental health experts focus on the oral system, prevent gum disease and encourage bright smiles, contributing to improving lives."}
              </p>
              <p>
              ...
              <h2>
                <strong>
                  {"Top Dental Colleges in India NIRF Ranking"}
                </strong>
              </h2>
              <p>
                {"Each year, the National Institutional Ranking Framework (NIRF) releases its rankings based on comprehensive data collected from various institutions. The rankings for the best BDS (Bachelor of Dental Surgery) colleges in India are determined using five key factors: graduation rate, research and professional practices, teaching and learning resources, outreach and inclusivity, and the overall reputation of the institutions."}
              </p>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/saveetha-medical-college-smc-chennai")} target={"_blank"} rel={"noopener"}>
                        <strong>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/manipal-college-of-dental-sciences-mcds-mangalore")} target={"_blank"} rel={"noopener"}>
                        <strong>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/maulana-azad-institute-of-dental-sciences-maids-new-delhi")} target={"_blank"} rel={"noopener"}>
                        <strong>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/dr-dy-patil-vidyapeeth-ddypv-pune")} target={"_blank"} rel={"noopener"}>
                        <strong>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/ab-shetty-memorial-institute-of-dental-sciences-mangalore")} target={"_blank"} rel={"noopener"}>
                        <strong>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/srm-dental-college-chennai")} target={"_blank"} rel={"noopener"}>
                        <strong>
                          {"SRM Dental College"}
                        </strong>
                      </a>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/siksha-o-anusandhan-university-soau-bhubaneswar")} target={"_blank"} rel={"noopener"}>
                        <strong>
                          {"SOA University"}
                        </strong>
                      </a>
              ...
              <h2 id={"TopDentalIND_e"}>
                {"Top Private Dental Colleges in India"}
              </h2>
              <p>
                {"Top Private Dental Colleges in India: A List of the Best BDS Colleges with Fee Structure"}
              </p>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                <colgroup>
                  <col width={"492"} />
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/jss-dental-college-and-hospital-mysore")} target={"_blank"} rel={"noopener"}>
                        <strong>
              ...
              <h2 id={"TopDentalIND_f"}>
                {"Top Government Dental Colleges in India"}
              </h2>
              <p>
                {"Top Government Dental Colleges in India: Complete List with Fees"}
              </p>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                <colgroup>
                  <col width={"417"} />
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a href={allowedLink("/college/datta-meghe-institute-of-engineering-technology-and-research-dmietr-wardha")} target={"_blank"} rel={"noopener"}>
                        <strong>
              ...
              <h2>
                <strong>
                  {"Highest Salary Packages Offered by Top Dental Colleges in India"}
                </strong>
              </h2>
              <p>
                {"The best Dental colleges in India with the total tuition fee and annual average package are tabulated below:"}
              </p>
              <table dir={"ltr"} border={"1"} cellSpacing={"0"} cellPadding={"0"}>
                <colgroup>
                  <col width={"331"} />
          ...
          <div className={"col-md-6 mobile__white__bg"}>
            <div className={"filter__selected__container"}>
              <div id={"selectedFilters"} className={"filterDiv"}>
                <button id={"dental"} data-attr={"stream"} className={"filter__selected"}>
                  {"Dental"}
            ...
            <div className={"filtered__colleges__list"}>
              <div className={"searchedcollegeList"}>
                    <div className={"college__card__new "} key={"MAIDS01"} id={"search-MAIDS01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            ...
                            alt={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/MAIDS01")} title={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi Reviews"} href={allowedLink("/reviews")}>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi is a top accredited Government institute located in New Delhi, Delhi. Code: MAIDS01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi Courses"}>
                                  {"9 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Maulana Azad Institute of Dental Sciences (MAIDS), New Delhi"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"MCODS01"} id={"search-MCODS01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Manipal College of Dental Sciences, Manipal"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/MCODS01")} title={"Manipal College of Dental Sciences, Manipal"}>
                                {"Manipal College of Dental Sciences, Manipal"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Manipal College of Dental Sciences, Manipal Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Manipal College of Dental Sciences, Manipal is a top accredited Private institute located in Manipal, Karnataka. Code: MCODS01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Manipal College of Dental Sciences, Manipal Courses"}>
                                  {"12 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Manipal College of Dental Sciences, Manipal"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Manipal College of Dental Sciences, Manipal"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"KGMU-D"} id={"search-KGMU-D"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"King George's Medical University (Faculty of Dental Sciences), Lucknow"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/KGMU-D")} title={"King George's Medical University (Faculty of Dental Sciences), Lucknow"}>
                                {"King George's Medical University (Faculty of Dental Sciences), Lucknow"}
                              </a>
                            </h2>
                            <div className={"detail__list__mobile"}>
                              <span className={"list__style college__location"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"King George's Medical University (Faculty of Dental Sciences), Lucknow Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"King George's Medical University (Faculty of Dental Sciences), Lucknow is a top accredited Government institute located in Lucknow, Uttar Pradesh. Code: KGMU-D."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"King George's Medical University (Faculty of Dental Sciences), Lucknow Courses"}>
                                  {"10 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"King George's Medical University (Faculty of Dental Sciences), Lucknow"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"King George's Medical University (Faculty of Dental Sciences), Lucknow"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"NHDC01"} id={"search-NHDC01"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"Nair Hospital Dental College, Mumbai"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/NHDC01")} title={"Nair Hospital Dental College, Mumbai"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"Nair Hospital Dental College, Mumbai Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"Nair Hospital Dental College, Mumbai is a top accredited Government institute located in Mumbai, Maharashtra. Code: NHDC01."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"Nair Hospital Dental College, Mumbai Courses"}>
                                  {"8 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"Nair Hospital Dental College, Mumbai"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"Nair Hospital Dental College, Mumbai"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
                    <div className={"college__card__new "} key={"ABSMIDS"} id={"search-ABSMIDS"}>
                      <div className={"card__header__row"}>
                        <div className={"college__detail__grid"}>
                          <img 
                            width={"56"} 
                            ...
                            className={"college__image"} 
                            src={"https://media.getmyuni.com/azure/college-image/small/university-college-of-medical-sciences-ucms-new-delhi.jpg"} 
                            alt={"AB Shetty Memorial Institute of Dental Sciences, Mangalore"} 
                          />
                          <div className={"college__detail__row"}>
                            <h2 className={"college__name"}>
                              <a href={allowedLink("/college/ABSMIDS")} title={"AB Shetty Memorial Institute of Dental Sciences, Mangalore"}>
                            ...
                            <div className={"detail__list__mobile"}>
                              ...
                              <a className={"list__style list__style__rating"} target={"_blank"} title={"AB Shetty Memorial Institute of Dental Sciences, Mangalore Reviews"} href={allowedLink("/reviews")}>
                                <span className={"list__style college__rating"}>
                                  <span className={"spriteIcon__2 review__star__icon"}></span>
                                  {"4.5"}
                                </span>
                      ...
                      <div className={"summary-text fsdfsdfs"}>
                        <p className={"template-text1 template-text add-read-more show-less-content"}>
                          {"AB Shetty Memorial Institute of Dental Sciences, Mangalore is a top accredited Private institute located in Mangalore, Karnataka. Code: ABSMIDS."}
                        </p>
                      </div>
                      <div className={"highlight__cta__row"}>
                        <div className={"highlights__grid"}>
                          <div className={"highlight__div"}>
                            ...
                            <span className={"highlight__value"}>
                              <h3>
                                <a title={"AB Shetty Memorial Institute of Dental Sciences, Mangalore Courses"}>
                                  {"11 Courses"}
                                </a>
                              </h3>
                            </span>
                        ...
                        <div className={"cta__grid"}>
                          <div className={"cta__div lead-cta-college-filter-2 leadFilterData apply-now-btn"} data-title={"Apply Now"} data-description={"AB Shetty Memorial Institute of Dental Sciences, Mangalore"}>{"Apply Now"}</div>
                          <div className={"cta__div lead-cta-college-filter-1 view-details-btn"} data-title={"View Details"} data-description={"AB Shetty Memorial Institute of Dental Sciences, Mangalore"}>{"View College"}</div>
                        </div>
                      </div>
                    </div>
              </div>
      ...
      <div className={"desktopOnly getSupport college-filter-get-support"}>
        <div className={"brochureBtn filter-college-scholership leadFilterData predict-my-college-cta"} data-filter={"college-listing"} data-entity={"college"} data-lead_cta={"22"} data-stream={"dental"} data-ctalocation={"colleges_listing_card_predict_my_college"}></div>
      </div>
...
export default function DentalPage({ onNavigate }) {
  return (
